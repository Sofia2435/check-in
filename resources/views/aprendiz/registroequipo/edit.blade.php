...
@section('contents')
    ...
    <div class="form-container mt-10">
        ...
        <form action="{{ route('registro-equipo.update', $equipo->id) }}" method="POST" class="space-y-4">
            @csrf
            @method('PUT')
            ...
            <div class="pt-4">
                <button type="submit"
                    class="w-full rounded-md px-4 py-3 text-lg font-semibold text-white shadow-sm hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-offset-2"
                    style="background-color:rgb(62, 113, 73);">
                    Actualizar Equipo
                </button>
        </form>
    </div>
