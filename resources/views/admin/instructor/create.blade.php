...
@section('title', 'Registro de Instructores')
...
<style>
    ...
    * {
    ...
    <form action="{{ route('instructor.store') }}" method="POST">
        ...
        <br>
        <div>
            <label class="block text-sm font-medium text-green-900" style="font-family: Caviar Dreams; font-size: 15px;">Correo Electronico</label><br>
        ...
        <br>
        <div>
            <label class="block text-sm font-medium text-green-900" style="font-family: Caviar Dreams; font-size: 15px;">Contraseña</label><br>
        ...
        <br>
        <button type="submit" class="w-full rounded-md px-4 py-3 text-lg font-semibold text-green-700 shadow-sm hover:bg-green-500 focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-offset-2" style="background-color:rgb(187, 255, 168); font-family:Caviar Dreams;">
             Enviar
         </button>
    </form>
    </div>
