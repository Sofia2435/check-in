...
<div class="max-w-md mx-auto shadow-md rounded-lg p-6 mt-6" style="background-color:rgb(232, 255, 225); font-family: Caviar Dreams;">
    <h2 class="text-2xl font-bold mb-6 text-center">Editar Aprendiz</h2>

    <form action="{{ route('aprendices.update', $user->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="text-center">
            <button type="submit" class="text-green-700 px-5 py-2 rounded-md hover:bg-green-300 transition duration-200" style="background-color:rgb(228, 255, 220);">
                Actualizar
            </button>
        </div>
    </form>
