...
<div class="max-w-5xl mx-auto shadow-md rounded-lg p-6 mt-6" style="background-color: rgb(232, 255, 238);">
    ...
    <div class="mb-4 text-left">
        <a href="{{ route('carnet_digital.create') }}" class="text-green-700 hover:bg-blue-800 px-4 py-2 rounded-md" style="background-color:rgb(157, 220, 137); font-family: Caviar Dreams;">
            Agregar Datos
        </a>
    </div>
