...
<div class="max-w-2xl mx-auto bg-white shadow-md p-6 mt-8 rounded-lg" style="background-color:rgb(232, 255, 238)">
    ...
    <div class="mt-4">
        <a href="{{ route('instructores.justificacion.index') }}" class="text-green-600 hover:underline">← Volver</a>
    </div>
</div>
@endsection
